            ...
            >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your current weight",
                  },
                ]}
              >
                <div>
                ...
                <Input fullWidth onChange={(text) => setcurrentWeight(text)} />
              </Form.Item>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input your targeted body weight!",
                  },
                ]}
              >
                <label>What is your targeted goal?(in kg's)</label>
                <Input fullWidth onChange={(text) => setbodygoalWeight(text)} />
              </Form.Item>
