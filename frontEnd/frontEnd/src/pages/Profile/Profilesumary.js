...
export default function Profilesumary({ context }) {
                ...
                <div>
                  <div class='card card-primary card-outline'>
                    <div class='card-body'>
                      ...
                      <br />
                      <p class='card-text'>
                        You have only completed one workout, Continue with your
                        streak to find out your Improvements
                      </p>
                      <hr />
                      <p>
                        <label>
                      ...
                      <p class='card-text'>
                        You have only completed one workout, Continue with your
                        streak to find out your Focus Points
                      </p>
                      <br />
                      <hr />{" "}
                      <MDBCard>
